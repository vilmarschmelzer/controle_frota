...
urlpatterns = patterns('',
    ...
    url(r'^relatorio-servidores/$', 'app_frota.views.servidor.relatorio', name='relatorio-servidores'),
    url(r'^imprimir-relatorio-servidores/$', 'app_frota.views.servidor.imprimir_relatorio', name='imprimir-relatorio-servidores'),
    ...
    url(r'^relatorio-veiculos/$', 'app_frota.views.veiculo.relatorio', name='relatorio-veiculos'),
     url(r'^imprimir-relatorio-veiculos/$', 'app_frota.views.veiculo.imprimir_relatorio', name='imprimir-relatorio-veiculos'),
